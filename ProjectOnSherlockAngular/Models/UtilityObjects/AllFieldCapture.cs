...
using ProjectOnSherlockAngular.Models.UtilityObjects;
using ProjectOnSherlockAngular.Models.UtilityObjects.HealthEnum;
using ProjectOnSherlockAngular.Models.UtilityObjects.LoanEnum;
using ProjectOnSherlockAngular.Models.UtilityObjects.PPIEnum;
using System;

namespace ProjectOnSherlockAngular.UtilityObjects
{
    public class AllFieldCapture
    {
        ...
        //Solar
        public ProjectOnSherlockAngular.Models.UtilityObjects.SolarPropertyTypeEnum SolarPropertyType { get; set; }
        ...
        public ProjectOnSherlockAngular.Models.UtilityObjects.AccidentType AccidentType { get; set; }
